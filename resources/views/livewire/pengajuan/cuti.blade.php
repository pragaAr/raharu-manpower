<div>
  ...
  @include('components.partials.header', ['title' => $title, 'permission' => 'pengajuan-cuti.create'])
        ...
        <table class="table table-vcenter table-bordered">
          ...
          <tbody>
            ...
            <tr wire:key="{{ $row->id }}">
              ...
              <td>{{ $row->tanggal_mulai?->format('d-m-Y') ?? '-' }} s/d {{ $row->tanggal_selesai?->format('d-m-Y') ?? '-' }}</td>
  ...
  @include('livewire.pengajuan.cuti-modal')
