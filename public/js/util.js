...
window.bindTomSelectModalValidation = function ({ modalEl, selectEl, errorEl }) {
  if (!modalEl) return;
  ...
  const bindObserver = () => {
    ...
    const checkError = () => {
      selectEl.tomselect.wrapper.classList.toggle('is-invalid', !!errorEl.querySelector('small'));
    };
